							...
							<form:form action="gerar" method="post" modelAttribute="relatorio">
								...
								<div class="form-row">
							  		<div class="form-group col-md-3">
							      		...
							      		<input type="date" class="form-control" id="dataInicio" name="dataInicio" required="required">
							    	</div>
							    	
							    	<div class="form-group col-md-3">
							      		<label for="dataFimLocacao">Data Fim</label>
							      		<input type="date" class="form-control" id="dataFim" name="dataFim" required="required">
							    	</div>
							   </div>
