			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Locações Realizadas</h1>
					</div>
					
					<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Locações Realizadas</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                    	<c:forEach var="locacao" items="${locacoes}">
											<tr>
												...
												<td>${locacao.carro.placa}</td>
												<td>${locacao.statusStr}</td>
												<td>
													<a href="visualizar?id=${locacao.id}" class="btn btn-success btn-circle btn-sm">
