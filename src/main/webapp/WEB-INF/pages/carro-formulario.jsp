			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Carro</h1>
					</div>
					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <c:choose>
								<c:when test="${carro.id == null}">
									<h6 class="m-0 font-weight-bold text-primary">Cadastrar Carro</h6>
								</c:when>
								<c:otherwise>
									<h6 class="m-0 font-weight-bold text-primary">Alterar Carro</h6>
								</c:otherwise>
							</c:choose>
                        </div>
                        ...
                        <div class="card-body">
							...
							<form:form action="salvar" method="post" modelAttribute="carro">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
										...
										<select class="form-control" id="single-select-field" name="marca.id" required="required">
							  		...
							  		<div class="form-group col-md-3">
										...
										<select class="form-control" id="single-select-field" name="modelo.id" required="required">
							    	...
							    	<div class="form-group col-md-2">
							      		...
							      		<input type="text" class="form-control" id="placa" name="placa" value="${carro.placa}" required="required">
							    	</div>
							    	...
							    	<div class="form-group col-md-2">
										...
										<select class="form-control" id="disponivel" name="disponivel" required="required">
											<c:choose>
												<c:when test="${carro.disponivel == true}">
													<option value="true" selected="selected">Disponível</option>
													<option value="false">Indisponível</option>
												</c:when>
												<c:otherwise>
													<option value="true">Disponível</option>
													<option value="false" selected="selected">Indisponível</option>
												</c:otherwise>
											</c:choose>
										</select>
									</div>
							  	...
							  	<div class="card-footer">
									...
									<a class="btn btn-sm btn-secondary" href="/locadora/carro/listar" role="button">Cancelar</a>
								</div>
