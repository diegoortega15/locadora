                        ...
                        <div class="card-header py-3">
                            <c:choose>
								<c:when test="${perfil.id == null}">
									<h6 class="m-0 font-weight-bold text-primary">Cadastrar Perfil</h6>
								</c:when>
								<c:otherwise>
							...
							<form:form action="salvar" method="post" modelAttribute="perfil">
								...
								<div class="form-row">
							  	...
							  	<div class="row mb-4">
									...
									<div class="col-md-2">
										<label class="form-label" for="painel">Painel</label> 
										<select class="form-control" id="painel" name="funcionalidade.painel" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.painel == true}">
									...
									<div class="col-md-2">
										<label class="form-label" for="grupoOperacao">Operação</label> 
										<select class="form-control" id="grupoOperacao" name="funcionalidade.grupoOperacao" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.grupoOperacao == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										<label class="form-label" for="locacao">Locação</label> 
										<select class="form-control" id="locacao" name="funcionalidade.locacao" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.locacao == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										<label class="form-label" for="locacoesRealizadas">Locações Realizadas</label> 
										<select class="form-control" id="locacoesRealizadas" name="funcionalidade.locacoesRealizadas" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.locacoesRealizadas == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
								...
								<div class="row mb-4">
									...
									<div class="col-md-2">
										<label class="form-label" for="minhasLocacoes">Minhas Locações</label> 
										<select class="form-control" id="minhasLocacoes" name="funcionalidade.minhasLocacoes" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.minhasLocacoes == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										<label class="form-label" for="finalizarLocacao">Finalizar Locação</label> 
										<select class="form-control" id="finalizarLocacao" name="funcionalidade.finalizarLocacao" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.finalizarLocacao == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="relatorio" name="funcionalidade.relatorio" required="required">
											<c:choose>
									...
									<div class="col-md-2">
										<label class="form-label" for="grupoCadastros">Grupo Cadastros</label> 
										<select class="form-control" id="grupoCadastros" name="funcionalidade.grupoCadastros" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.grupoCadastros== true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
								...
								<div class="row mb-4">
									...
									<div class="col-md-2">
										<label class="form-label" for="itemAdcional">Item Adcional</label> 
										<select class="form-control" id="itemAdcional" name="funcionalidade.itemAdcional" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.itemAdcional == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										<label class="form-label" for="localRetirada">Local Retirada</label> 
										<select class="form-control" id="localRetirada" name="funcionalidade.localRetirada" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.localRetirada == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="marca" name="funcionalidade.marca" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.marca == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="modelo" name="funcionalidade.modelo" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.modelo == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
								...
								<div class="row mb-4">
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="carro" name="funcionalidade.carro" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.carro == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-3">
										<label class="form-label" for="grupoControleAcesso">Grupo Controle Acesso</label> 
										<select class="form-control" id="grupoControleAcesso" name="funcionalidade.grupoControleAcesso" required="required">
											<c:choose>
												<c:when test="${perfil.funcionalidade.grupoControleAcesso == true}">
													<option value="true" selected="selected">Sim</option>
													<option value="false">Não</option>
												</c:when>
												<c:otherwise>
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="cliente" name="funcionalidade.cliente" required="required">
											<c:choose>
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="funcionario" name="funcionalidade.funcionario" required="required">
											<c:choose>
									...
									<div class="col-md-2">
										...
										<select class="form-control" id="perfil" name="funcionalidade.perfil" required="required">
											<c:choose>
							  	...
							  	<div class="card-footer">
									...
									<a class="btn btn-sm btn-secondary" href="/locadora/perfil/listar" role="button">Cancelar</a>
								</div>
