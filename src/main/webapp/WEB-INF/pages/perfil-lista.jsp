			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<div>
							<a href="/locadora/perfil/novo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
								<i class="fa fa-plus-circle fa-sm text-white-50"></i> Novo Perfil
							</a>
						</div>
					</div>
					...
					<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Perfis Cadastrados</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                    	<c:forEach var="perfil" items="${listPerfil}">
											<tr>
												<td>${perfil.nome}</td>
												<td>
	                                            	<a href="editar?id=${perfil.id}" class="btn btn-primary btn-circle btn-sm">
				                                        <i class="fa fa-edit"></i>
				                                    </a>
				                                    
													<a href="deletar?id=${perfil.id}" class="btn btn-danger btn-circle btn-sm">
