				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Realizar Locação</h6>
                        </div>
							...
							<form:form action="salvar" method="post" modelAttribute="locacao">
								...
								<div class="form-row">
							    	<div class="form-group col-md-4">
										...
										<select class="form-control" id="single-select-field" name="marca.id" required="required" disabled="disabled">
											...
											<c:forEach var="marcaVar" items="${marcas}">
												<c:choose>
													<c:when test="${carro.marca.id == marcaVar.id}">
							  		...
							  		<div class="form-group col-md-4">
										...
										<select class="form-control" id="single-select-field" name="modelo.id" required="required" disabled="disabled">
											...
											<c:forEach var="modeloVar" items="${modelos}">
												<c:choose>
													<c:when test="${carro.modelo.id == modeloVar.id}">
							    	...
							    	<div class="form-group col-md-2">
							      		...
							      		<input type="text" class="form-control" id="placa" name="placa" value="${carro.placa}" required="required" disabled="disabled">
							    	</div>
							    	
							    	<div class="form-group col-md-2">
							      		<label for="quilometragem">Quilometragem</label>
							      		<input type="number" class="form-control" id="quilometragem" name="quilometragem" value="${carro.quilometragem}" disabled="disabled" >
							    	</div>
							    	
							  	</div>
							  	
							  	<c:if test="${isCliente == false}">
							  		...
							  		<div class="form-row">
								  		<div class="form-group col-md-3">
								      		...
								      		<input type="text" class="form-control" id="cpf" name="cpf" onblur="carregarCliente()"
								      			data-inputmask='"mask": "999.999.999-99"' data-mask required="required" >
								    	</div>
								  	...
								  	<div class="form-row">
								  		<div class="form-group col-md-12">
								      		...
								      		<textarea class="form-control" id="endereco" name="endereco" rows="2" cols="200" disabled="disabled"></textarea>
								    	</div>
								...
								<h5>Locação</h5>
							  	...
							  	<div class="form-row">
							  		...
							  		<div class="form-group col-md-3">
							      		...
							      		<input type="date" class="form-control" id="dataInicioLocacaoStr" name="dataInicioLocacaoStr" >
							    	</div>
							    	
							    	<div class="form-group col-md-3">
							      		<label for="dataFimLocacao">Data Fim</label>
							      		<input type="date" class="form-control" id="dataFimLocacaoStr" name="dataFimLocacaoStr" >
							    	</div>
							    	
							    	<div class="form-group col-md-6">
							  			<label for="modelo">Local de Retirada</label> 
										<select class="form-control" id="single-select-field" name="localRetirada.id" required="required" >
			...
			if (document.getElementById('cpf').value != "") {
				...
				$.ajax({
		            ...
		            success : function(response) {
		            	...
		            	if (response[0].nome == "") {
		            		alert("Cliente não cadastrado ou sem CPF cadastrado!");
