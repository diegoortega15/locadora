...
<body id="page-top">
	...
	<script type="text/javascript">
	    ...
	    function drawChart() {
	    	...
	    	$.ajax({
	            url : "/locadora/relatorio/geral/dados",
	            data : param,
	            dataType : "JSON",
	            type : "GET",
	            ...
	            success : function(response) {
	            	var dataArray = [
	            		['Dados', 'Total de locações', 'Locações em andamento', 'Locações finalizadas', 'Clientes cadastrados', 'Carros cadastrados'],
	            	];
	            	
	            	for (var i = 0; i < response.length; i++) {
	                    var row = [response[i].dados, response[i].locacao, response[i].locacaoAndamento, response[i].locacaoFinalizados, response[i].clientes, response[i].carros];
	                    dataArray.push(row);
	                }
	        		...
	        		var data = google.visualization.arrayToDataTable(dataArray);
	         		...
	         		var options = {
	        			chart: {
	                    	...
	                    	subtitle: 'Relatório com o quantitativo das locações.',
	                  	},
