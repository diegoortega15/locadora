			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<h1 class="h3 mb-0 text-gray-800">Item Adicional</h1>
						
						<div>
							<a href="/locadora/item-adicional/novo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
								<i class="fa fa-plus-circle fa-sm text-white-50"></i> Novo Item
							</a>
							
							<a href="/locadora/item-adicional/exportar" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
					...
					<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Itens Adicionais Cadastrados</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    	<c:forEach var="itemAdicional" items="${listItemAdicional}">
											<tr>
												<td>${itemAdicional.nome}</td>
												<td>
	                                            	<a href="editar?id=${itemAdicional.id}" class="btn btn-primary btn-circle btn-sm">
				                                        <i class="fa fa-edit"></i>
				                                    </a>
				                                    
													<a href="deletar?id=${itemAdicional.id}" class="btn btn-danger btn-circle btn-sm">
