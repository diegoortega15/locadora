			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Funcionario</h1>
						<a href="/locadora/funcionario/novo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
							<i class="fa fa-plus-circle fa-sm text-white-50"></i> Novo Funcionario
						</a>
					</div>
                                    ...
                                    <tbody>
                                    	<c:forEach var="funcionario" items="${listFuncionario}">
											<tr>
												...
												<td>
	                                            	<a href="editar?id=${funcionario.id}" class="btn btn-primary btn-circle btn-sm">
				                                        <i class="fa fa-edit"></i>
				                                    </a>
				                                    
													<a href="deletar?id=${funcionario.id}" class="btn btn-danger btn-circle btn-sm">
