			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<div>
							<a href="/locadora/modelo/novo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
								<i class="fa fa-plus-circle fa-sm text-white-50"></i> Novo Modelo
							</a>
							
							<a href="/locadora/modelo/exportar" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                                    ...
                                    <tbody>
                                    	<c:forEach var="modelo" items="${listModelo}">
											<tr>
												...
												<td>${modelo.nome}</td>
												<td>
	                                            	<a href="editar?id=${modelo.id}" class="btn btn-primary btn-circle btn-sm">
				                                        <i class="fa fa-edit"></i>
				                                    </a>
				                                    
													<a href="deletar?id=${modelo.id}" class="btn btn-danger btn-circle btn-sm">
