				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <c:choose>
								<c:when test="${modelo.id == null}">
									<h6 class="m-0 font-weight-bold text-primary">Cadastrar Modelo</h6>
								</c:when>
								<c:otherwise>
									<h6 class="m-0 font-weight-bold text-primary">Alterar Modelo</h6>
								</c:otherwise>
							</c:choose>
                        </div>
                        ...
                        <div class="card-body">
							...
							<form:form action="salvar" method="post" modelAttribute="modelo">
								...
								<div class="form-row">
									<div class="form-group col-md-3">
										...
										<select class="form-control" id="single-select-field" name="marca.id" required="required">
											...
											<c:forEach var="marcaVar" items="${marcas}">
												<c:choose>
													<c:when test="${modelo.marca.id == marcaVar.id}">
							    	...
							    	<div class="form-group col-md-9">
							      		...
							      		<input type="text" class="form-control" id="nome" name="nome" value="${modelo.nome}" required="required">
							    	</div>
							  	...
							  	<div class="card-footer">
									...
									<a class="btn btn-sm btn-secondary" href="/locadora/modelo/listar" role="button">Cancelar</a>
								</div>
