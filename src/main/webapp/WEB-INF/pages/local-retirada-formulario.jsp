				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <c:choose>
								<c:when test="${localRetirada.id == null}">
									<h6 class="m-0 font-weight-bold text-primary">Cadastrar Local de Retirada</h6>
								</c:when>
								<c:otherwise>
									<h6 class="m-0 font-weight-bold text-primary">Alterar Local de Retirada</h6>
								</c:otherwise>
							</c:choose>
                        </div>
                        ...
                        <div class="card-body">
							...
							<form:form action="salvar" method="post" modelAttribute="localRetirada">
								
								<input type="hidden" id="id" name="id" value="${localRetirada.id}" />
								
								<div class="form-row">
							    	<div class="form-group col-md-12">
							      		<label for="nome">Nome</label>
							      		<input type="text" class="form-control" id="nome" name="nome" value="${localRetirada.nome}" required="required">
							    	</div>
							  	</div>
								...
								<div class="form-row">
							    	<div class="form-group col-md-12">
							      		...
							      		<input type="text" class="form-control" id="logradouro" name="endereco.logradouro" value="${localRetirada.endereco.logradouro}"  required="required">
							    	</div>
							  	</div>	
							  	...
							  	<div class="form-row">
							    	<div class="form-group col-md-4">
							      		...
							      		<input type="text" class="form-control" id="bairro" name="endereco.bairro" value="${localRetirada.endereco.bairro}"  required="required">
							    	</div>
							    	
							    	<div class="form-group col-md-3">
							      		<label for="cidade">Cidade</label>
							      		<input type="text" class="form-control" id="municipio" name="endereco.municipio" value="${localRetirada.endereco.municipio}" required="required">
							    	</div>
							    	
							    	<div class="form-group col-md-3">
							      		<label for="estado">Estado</label>
							      		<input type="text" class="form-control" id="estado" name="endereco.estado" value="${localRetirada.endereco.estado}" required="required">
							    	</div>
							    	
							    	<div class="form-group col-md-2">
							      		<label for="cep">CEP</label>
							      		<input type="text" class="form-control" id="cep" name="endereco.cep" value="${localRetirada.endereco.cep}" required="required">
							    	</div>
							  	</div>	
							  	...
							  	<div class="form-row">
							    	<div class="form-group col-md-12">
							      		...
							      		<input type="text" class="form-control" id="complemento" value="${localRetirada.endereco.complemento}" name="endereco.complemento" >
							    	</div>
							  	</div>	
							  	
							  	<div class="card-footer">
									<button type="submit" class="btn btn-sm btn-primary">Salvar</button>
									<a class="btn btn-sm btn-secondary" href="/locadora/item-adicional/listar" role="button">Cancelar</a>
								</div>
