			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<a href="/locadora/cliente/novo" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
							<i class="fa fa-plus-circle fa-sm text-white-50"></i> Novo Cliente
						</a>
					</div>
                                    ...
                                    <tbody>
                                    	<c:forEach var="cliente" items="${listCliente}">
											<tr>
												...
												<td>${cliente.email}</td>
												<td>
	                                            	<a href="editar?id=${cliente.id}" class="btn btn-primary btn-circle btn-sm">
				                                        <i class="fa fa-edit"></i>
				                                    </a>
				                                    
													<a href="deletar?id=${cliente.id}" class="btn btn-danger btn-circle btn-sm">
